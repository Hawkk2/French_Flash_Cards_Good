# This app can be made better with adjustor for the flip_timer as well as a logrythmic recall timer to
# reinsert past know words as well as past unknown words at longer and shorter intervals respectively.
...
def next_card():
    ...
    window.after(2250, func=flip_card)
...
flip_timer = window.after(2250, func=flip_card)
...
#canvas.create_image(image=known_button_img)
#canvas.config(bg=BACKGROUND_COLOR, highlightthickness=0)
